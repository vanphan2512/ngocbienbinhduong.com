                            ...
                            if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                                ...
                                <tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									if($terms[0]->term_id==73){
										echo '<ul class="cart_edit_nnv"><li><a href="#">Show Details</a></li>|<li><a href="'.get_bloginfo('url').'/custom-design?action=edit_product&custom_product_id='.$cart_item['product_id'].'">Edit Product</a></li>|<li><a href="#">Design Similar</a></li></ul>';
									}
									elseif($terms[0]->term_id==74){
										echo '<ul class="cart_edit_nnv"><li><a href="#">Show Details</a></li>|<li><a href="'.get_bloginfo('url').'/design-jackets?action=edit_product&custom_product_id='.$cart_item['product_id'].'">Edit Product</a></li>|<li><a href="#">Design Similar</a></li></ul>';
									}
									elseif($terms[0]->term_id==75){
										echo '<ul class="cart_edit_nnv"><li><a href="#">Show Details</a></li>|<li><a href="'.get_bloginfo('url').'/design-blazers?action=edit_product&custom_product_id='.$cart_item['product_id'].'">Edit Product</a></li>|<li><a href="#">Design Similar</a></li></ul>';
									}
