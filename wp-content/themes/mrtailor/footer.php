...
<footer id="site-footer" role="contentinfo">
    <div class="skype-chat">
      <?php //echo do_shortcode('[Wow-Skype-Buttons id=1]');?>
    ...
    <?php if (is_active_sidebar('footer-widget-area')) : ?>
        ...
        <div class="site-footer-widget-area">
            <div class="row">
                ...
                <div class="large-8 medium-12 small-12 columns footer-widget-maps">
                    <h3 class="widget-title">Bản đồ</h3>
                     <script src='https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyBMu-xXoekL1neWJEDFNaV-PIPJjj2eqXU'></script>
                     <div style='overflow:hidden;height:250px;width:100%;'>
                         ...
                         <div><small><a href="https://premiumlinkgenerator.com/">Visit this site!</a></small>
                         </div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div>
                         <script type='text/javascript'>
                            function init_map(){
                            var myOptions = {
                                zoom:10,
                                center:new google.maps.LatLng(11.0004564024115,106.65278497514646),
                                mapTypeId: google.maps.MapTypeId.ROADMAP};
                                map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);
                                marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(11.0004564024115,106.65278497514646)});
                                infowindow = new google.maps.InfoWindow({content:'<strong style>Ngọc Biển</strong><br>Số 12, Đại lộ Bình Dương, tổ 11, khu phố Đông, phường Vĩnh Phú, thị xã Thuận An, tỉnh Bình Dương<br>'});
...
<script type="text/javascript">
    ...
    {
        var uprofile_value = document.getElementById('uprofile').value;
        var arr = uprofile_value.split("_");
        var profile_id = arr[0];
        var measurement = get_profile_type(profile_id);
        var measurement = arr[1];
...
<!-- <script type='text/javascript'>
(function(){ var widget_id = 'xjAFygGhT4';var d=document;var w=window;function l(){
var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = '//code.jivosite.com/script/widget/'+widget_id; var ss = document.getElementsByTagName('script')[0]; ss.parentNode.insertBefore(s, ss);}if(d.readyState=='complete'){l();}else{if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();</script> -->
<!-- {/literal} END JIVOSITE CODE -->
<script lang="javascript">(function() {var pname = ( (document.title !='')? document.title : document.querySelector('h1').innerHTML );var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async=1; ga.src = '//live.vnpgroup.net/js/web_client_box.php?hash=97a3d092106b9e74c9925bdd8bfbec1d&data=eyJzc29faWQiOjUwMzgyMzIsImhhc2giOiIyNzdkMmE0MDM4YzFmYjU0MTk2NDIzNzM0YTEyZjZhNSJ9&pname='+pname;var s = document.getElementsByTagName('script');s[0].parentNode.insertBefore(ga, s[0]);})();</script>
