...
function mr_tailor_custom_styles() {	
	...
	<style>
		...
		{ 
			font-family: <?php if ($mr_tailor_theme_options['main_font_source'] == "2") echo '"' . $mr_tailor_theme_options['main_typekit_font_face'] . '",'; ?><?php if ($mr_tailor_theme_options['main_font_source'] == "1") echo '"' . $mr_tailor_theme_options['main_font']['font-family'] . '",'; ?> sans-serif;
		}
		...
		{ 
			font-family: <?php if ($mr_tailor_theme_options['main_font_source'] == "2") echo '"' . $mr_tailor_theme_options['main_typekit_font_face'] . '",'; ?><?php if ($mr_tailor_theme_options['main_font_source'] == "1") echo '"' . $mr_tailor_theme_options['main_font']['font-family'] . '",'; ?> sans-serif !important;
		}			
		...
		.mobile-navigation
		{
			font-family: <?php if ($mr_tailor_theme_options['secondary_font_source'] == "2") echo '"' . $mr_tailor_theme_options['secondary_typekit_font_face'] . '",'; ?><?php if ($mr_tailor_theme_options['secondary_font_source'] == "1") echo '"' . $mr_tailor_theme_options['secondary_font']['font-family'] . '",'; ?> sans-serif;
		}
		...
		.vc_btn
		{
			font-family: <?php if ($mr_tailor_theme_options['secondary_font_source'] == "2") echo '"' . $mr_tailor_theme_options['secondary_typekit_font_face'] . '",'; ?><?php if ($mr_tailor_theme_options['secondary_font_source'] == "1") echo '"' . $mr_tailor_theme_options['secondary_font']['font-family'] . '",'; ?> sans-serif !important;
		}		
