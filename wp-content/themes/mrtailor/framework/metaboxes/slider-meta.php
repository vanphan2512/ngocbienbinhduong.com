...
<div class="slider_metabox">
    ...
    <p>
        ...
        <label for="style_1"><img src="<?php echo get_template_directory_uri() . '/framework/images/metaboxes/style_1.png'; ?>" alt="" /></label>
        ...
        <label for="style_2"><img src="<?php echo get_template_directory_uri() . '/framework/images/metaboxes/style_2.png'; ?>" alt="" /></label>
        -->
        ...
        <label for="style_3" id="style_3_label"><img src="<?php echo get_template_directory_uri() . '/framework/images/metaboxes/style_3.png'; ?>" alt="" /></label>
        ...
        <label for="style_4"><img src="<?php echo get_template_directory_uri() . '/framework/images/metaboxes/style_4.png'; ?>" alt="" /></label>
        ...
        <label for="style_5"><img src="<?php echo get_template_directory_uri() . '/framework/images/metaboxes/style_5.png'; ?>" alt="" /></label>
        -->
        ...
        <label for="style_6"><img src="<?php echo get_template_directory_uri() . '/framework/images/metaboxes/style_6.png'; ?>" alt="" /></label>
    </p>
