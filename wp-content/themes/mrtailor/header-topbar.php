<div id="site-top-bar">
    ...
    <div class="row">
        <div class="large-8 columns">
            <nav id="site-navigation-top-bar" class="main-navigation" role="navigation">                    
                ...
                <!-- <?php if (is_user_logged_in()) { ?>
                    <ul><li><a href="<?php echo get_site_url(); ?>/my-accounts/" class="logout_link"><?php _e('My Account', 'mr_tailor'); ?></a></li></ul>
                    ...
                    ?> 
                    <ul><li><a href="<?php echo get_site_url(); ?>/signup/" class="logout_link"><?php _e('Signup', 'mr_tailor'); ?></a></li></ul>
                    <ul><li><a href="<?php echo get_site_url(); ?>/my-account/" class="logout_link"><?php _e('Login', 'mr_tailor'); ?></a></li></ul>
                        <?php } ?>	 -->			
            </nav><!-- #site-navigation -->
        ...
        <div class="large-4 columns">
		    ...
		    <span>Hot line: </span><a href="tel:0274 3755393">0274 3755393</a></address>
