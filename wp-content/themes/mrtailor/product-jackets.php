<?php
/* Template Name:custom design Jackets */
    ...
    <div class="woocommerce">
        ...
        <div class="row">
            <nav class="woocommerce-breadcrumb stp_bredcum_nav" itemprop="breadcrumb"><a class="home" href="<?php echo home_url(); ?>">Home</a>
                <span class="delimiter"> / </span><a href="<?php echo home_url(); ?>/product-category/jackets/">Jackets</a><span class="delimiter">
                    / </span> <span><?php echo $post_details->post_title; ?> :</span> <span id="brdcrum_design" class="brdcrum_field"> Design </span><span class="delimiter_design">
