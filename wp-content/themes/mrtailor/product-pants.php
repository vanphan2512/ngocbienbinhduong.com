<?php
/* Template Name:custom design Pants */
...
<div class="content design-shirts-1-content">
    <div class="woocommerce">
        ...
        <!-- <div class="row">
         ...
         <span class="delimiter"> / </span><a href="<?php echo home_url(); ?>/product-category/design-your-own/">design your own</a><span class="delimiter">
             / </span><?php echo $post_details->post_title; ?> : <span id="brdcrum_design" class="brdcrum_field"> Design </span><span class="delimiter_design">
             - </span><span id="brdcrum_sizing"> Sizing </span></nav>

         </div>-->
        <div class="row">
            <nav class="woocommerce-breadcrumb stp_bredcum_nav" itemprop="breadcrumb"><a class="home" href="<?php echo home_url(); ?>">Home</a>
                <span class="delimiter"> / </span><a href="<?php echo home_url(); ?>/product-category/pants/">Pants</a><span class="delimiter">
                    / </span><?php echo $post_details->post_title; ?> : <span id="brdcrum_design" class="brdcrum_field"> Design </span><span class="delimiter_design">
                    - </span><span id="brdcrum_sizing"> Sizing </span></nav>
