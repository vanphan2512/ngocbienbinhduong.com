<?php
/* Template Name:custom design Suits */
    ...
    <div class="woocommerce">
        ...
        <div class="row">
            <nav class="woocommerce-breadcrumb stp_bredcum_nav" itemprop="breadcrumb"><a class="home" href="<?php echo home_url(); ?>">Home</a>
                <span class="delimiter"> / </span><a href="<?php echo home_url(); ?>/product-category/suits/">Suits</a><span class="delimiter">
                    / </span><?php echo $post_details->post_title; ?> : <span id="brdcrum_design" class="brdcrum_field"> Jacket </span><span class="delimiter_design">
                    - </span><span id="brdcrum_pnt_fied"> Pants </span><span class="delimiter_design">
            ...
            <div class="row">
                <div class="large-12 columns">
                    <form id="main-product-form" action="<?php bloginfo('url') ?>/?page_id=56972" method="post">
                        <div class="row-fluid">
                            <div class="span6" id="img_main_thumb">
                            ...
                            <?php include_once( 'template-parts/steps/product-step-design-pant.php' ); ?>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery('.browse-product-wrap.pant-design').removeClass('block');
        /*jQuery('.browse-product-wrap.pant-design').addClass('remove');*/
        ...
        jQuery('#brdcrum_design').click(function () {
            ...
            jQuery('.pant-design').addClass('remove');
            jQuery('.pant-design').removeClass('block');
            ...
            jQuery('#brdcrum_pnt_fied').removeClass('brdcrum_field');

            jQuery('#img_main_thumb').addClass('block');
        });

        jQuery('#brdcrum_pnt_fied').click(function () {
            jQuery('.browse-product-wrap.extract').addClass('remove');
            jQuery('.browse-product-wrap.extract').removeClass('block');
            jQuery('.measure-wrap').addClass('remove');
            jQuery('.measure-wrap').removeClass('block');
            ...
            jQuery('.pant-design').addClass('block');
            jQuery('.pant-design').removeClass('remove');


            jQuery('#brdcrum_pnt_fied').addClass('brdcrum_field');
        ...
        jQuery('.design.change-step').click(function () {
            ...
            jQuery('.browse-product-wrap.pant-design').addClass('block');
            jQuery('.browse-product-wrap.pant-design').removeClass('remove');
        ...
        /////////////////
        jQuery('.next.change-step').click(function () {
        ...
        jQuery('.extract.change-step').click(function () {
            ...
            //This code for Directly go to third step mesure yoyr body .
            jQuery('.third_step_rap').find('.select-sizing-option').trigger('click');

        });

        jQuery('.step-back-pant').click(function () {
