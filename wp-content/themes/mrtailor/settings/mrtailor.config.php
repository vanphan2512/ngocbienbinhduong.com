		...
		array (
			...
			'fields' => array (
				...
				array (
					...
					'type' => 'image_select',
					'options' => array (
						0 => get_template_directory_uri() . '/framework/images/theme_options/icons/header_1.png',
						1 => get_template_directory_uri() . '/framework/images/theme_options/icons/header_2.png',
					),
					'default' => 0,
