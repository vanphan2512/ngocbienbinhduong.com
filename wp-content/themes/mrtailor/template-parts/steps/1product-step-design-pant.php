...
<div class="browse-product-wrap pant-design span6" <?php if($_REQUEST['action']=='buy-now'){echo "style='display:none'";}?>>
...
<?php //if ($post_type == 'product-suit')	{ // Special Design for suits ?>
		...
		<?php $jackets_settings_id = 193; $pants_settings_id = 194; ?>
			...
			<div class="span12">
				...
				<?php if (get_field('design_settings', $jackets_settings_id))	{ ?>
					...
					<div class="browse-design-details-box">
						...
						<div id="pants-design-options" class="suit-content" style="display:block">
			...
			<div class="browse-design-purchase-box" style="clear:both">
						...
						<a class="btn change-step next" href="#extras-tab">
                        ...
                        <?php }else{?>
                          ...
                          <a href="#" class="btn-gray step-back-pant">
		...
		<?php } else { ?>
				...
				<div class="browse-design-details" id="ready-made">
					...
					<div class="browse-design-details-box browse-box">
						...
						while (has_sub_field('extras_settings', $settings_id))	{
							...
							if ($option_value != "No")	{ array_push($arr_extras,$option_name);
			...
			<?php // Load normal Template for all products ?>
				...
				<?php }  ?>
                 <?php if($slug_product[3]=='design-pants' || $slug_product[3]=='design-chinos'){?>
                    <div class="browse-design-purchase-box">
