...
<?php if ($post_type != 'product-pants' && $post_type != 'product-chinos'): ?>
    ...
    <div class="browse-product-wrap extract remove <?php echo $post_type; ?> span6" <?php
                    ...
                    <?php while (has_sub_field('extras_settings', $settings_id)) { ?>
                        ...
                        <div class="popup-window" id="extras-<?php echo $option_name; ?>" data-target="#target-<?php echo $option_name; ?>">
                            ...
                            <?php if ($option_name == 'contrasting-buttons' || $option_name == 'contrastingbuttonhole-stitching' || $option_name == 'waistband-lining' || $option_name == 'back-packet-lining' || $option_name == 'contrastingcollar-cuff-lining') {
                                ?>
                                <select name="<?php echo $option_name; ?>" style="width: 250px;height:<?php
                                if ($option_name == 'contrasting-buttons' || $option_name == 'waistband-lining' || $option_name == 'back-packet-lining') {
                                    echo "66px";
                                } elseif ($option_name == 'contrastingcollar-cuff-lining') {
                                    echo "104px";
                                } else {
                                    echo "42px";
                                }
                                ?>;" onchange="change_select_option(this)" id="target-<?php echo $option_name; ?>_popup">
                                        <?php
                                        $x = 0;
                                        ...
                                        <a href="#"><?php the_sub_field('option_name'); ?><?php
                                            if (!empty($price)) {
                                ...
                                <div class="mono_option">
                                    ...
                                    while (has_sub_field('options', $settings_id)) {
                                        ...
                                        <div class="popup-input-box<?php if ($selected_value == trim(get_sub_field('option_name'))) { ?> selected-option<?php } ?>" data-select="<?= trim(get_sub_field('option_name')); ?>-<?php echo $x - 1; ?>" data-option="<?php echo $option_name; ?>">
                                            ...
                                            <a href="#" class="styl<?php echo $l; ?>"><input type="radio" id="<?php the_sub_field('option_name'); ?>" value="<?php the_sub_field('option_name'); ?>" name="monogram_type" <?php
                                                if ($slec == "No") {
                                                    echo 'checked';
                                                }
                                                ?>    /> <label for="<?php the_sub_field('option_name'); ?>"><?php the_sub_field('option_name'); ?><label></a>
                                                    ...
                                                    <div class="popup-label" style="display:none;">
                                                        ...
                                                        if (get_field('monogram_positions', $settings_id)) {
                                                            ...
                                                            if ($settings_id == 191) {
                                                                ...
                                                                <div class="mono_pop_slt">
                                                                    ...
                                                                    <select name="extras[position]">
                                                                        ...
                                                                        <?php for ($h = 0; $h < count(get_field('monogram_positions', $settings_id)); $h++) {
                                                                            ...
                                                                            <option value="<?php echo $dd[$h]['monogram_position']; ?>"
                                                                            <?php if ($option_name == $selected_values['position']) { ?>
                                                                                        selected="selected"<?php } ?>><?php echo $dd[$h]['monogram_position']; ?></option>
                                                                ...
                                                                <?php
                                                                if (get_field('monogram_colors', $settings_id)) {
                                                                ...
                                                                <div class="mono_pop_slt" >
                                                                    ...
                                                                    <input type="text" id="mono_pop_text" name="extras[custom-text]" value="<?php echo $selected_values['custom-text']; ?>" maxlength="20" />
                                                                </div>
                                                                ...
                                                                if (get_field('monogram_colors', $settings_id)) {
                                                                    $ee = get_field('monogram_colors', $settings_id);
                                                                    ?>
                                                                    <div class="mono_pop_slt" style="width:100%; float:none;">
                                                                        <label for="popup-color"  style="width:20%; float:left;">Color</label>
                                                                        <select name="extras[color]">
                                                                            <option value="same as fabric">Same as Fabric</option>
                                                                            <?php for ($h = 0; $h < count($ee); $h++) {
                                                                                ?>
                                                                ...
                                                                <div class="mono_pop_slt" style="width:100%; float:none; overflow:hidden; margin:20px 0 0 0;">
                                                                    <label for="popup-name" style="width:20%; float:left;">Text</label>
                                                                    <input type="text" class="mono_txt" id="mono_pop_text" name="extras[custom-text]" value="<?php echo $selected_values['custom-text']; ?>" maxlength="20" />
                                                                </div>
                                    ...
                                    <script language="javascript">
                                        jQuery(document).ready(function ($) {
                                            ...
                                            $('.monogram-done').on('click', function (e) {
                                                ...
                                                //console.log($('.mono_option').find('input[type="radio"]:checked').val());
