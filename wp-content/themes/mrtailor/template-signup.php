                    ...
                    <div class="row">
                        ...
                        <div class="medium-4 columns">
                            <div class="account-img-container">
                                <img id="login-img" alt="My account"  width="164" height="209"  src="<?php echo get_template_directory_uri() . '/images/signup-image.jpg'; ?>" data-interchange="[<?php echo get_template_directory_uri() . '/images/my_account.png'; ?>, (default)], [<?php echo get_template_directory_uri() . '/images/my_account_retina.png'; ?>, (retina)]">
                            </div>
                        </div>
                            ...
                            <div class="account-forms-container">
                                ...
                                <div class="account-forms">
                                    ...
                                    /* if($_SESSION['mail_send']==1)
                                      ...
                                      echo '<p>Your voucher and an activation email has been send to you.</p>';
                                      }
                                      else if($_SESSION['mail_send']==2)
                                      {
                                      echo '<p>User already exists.</p>';
                                      }
                                      else
                                      { */
                                    echo do_shortcode("[opt]");
//}
                                    ?>
