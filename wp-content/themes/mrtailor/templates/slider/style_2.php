...
jQuery(document).ready(function($) {
	...
	function resize_slider_content() {
		if ($(window).innerWidth() > 1280 ) {
			$('.main-slider, .main-slider .swiper-container, .main-slider .swiper-container .main-slider-content, .main-slider .swiper-container .swiper-wrapper').css('height', $(window).innerHeight() - $('#site-top-bar').innerHeight() - $('.site-header').innerHeight() - $('#wpadminbar').innerHeight());
