...
$info_message = apply_filters( 'woocommerce_checkout_coupon_message', __( 'Have a coupon?', 'mr_tailor' ) . ' <a href="#" class="showcoupon">' . __( 'Click here to enter your code', 'mr_tailor' ) . '</a>' );
