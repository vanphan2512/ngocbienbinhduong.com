	...
	<div class="large-8 large-centered columns">
		<div class="thank_you_header text-center">
            ...
            <?php else : ?>
                ...
                <p><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Thank you. Your order has been received.', 'mr_tailor' ), $order ); ?></p>
...
<div class="row">
	<div class="medium-10 medium-centered  large-8 large-centered text-center columns">
		<div class="thank_you_header">
			...
			<p><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Thank you. Your order has been received.', 'mr_tailor' ), null ); ?></p>
