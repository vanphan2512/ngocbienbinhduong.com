...
<div class="row">
	<div class="large-12 columns scroll swiper-container">
	<div id="products-grid" class="row swiper-wrapper products products-grid  effect-<?php echo $effect; ?> small-block-grid-2 medium-block-grid-3 large-block-grid-<?php echo $products_per_column; ?> columns-<?php echo $products_per_column; ?>">
