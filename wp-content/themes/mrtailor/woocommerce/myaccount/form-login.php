						...
						<div class="account-forms">
							<form id="login" method="post" class="login-form">
								...
								<p class="lost_password">
									<a class="lost-pass-link" href="<?php echo  wp_lostpassword_url(); ?>">
										<?php _e( 'Lost your password?', 'mr_tailor' ); ?>
									</a>
								</p>
                                <?php
                                //$siteURL = get_option('siteurl');
//                                    echo var_dump('{$siteURL}/my-account/lost-password/');
                                ?>
                                <!--
								<p class="lost_password">                                
									<a class="lost-pass-link" href="<?php echo esc_url( wc_lostpassword_url() ); ?>" title="Lost Password" >
