...
<div class="product_meta">
	...
	<?php echo $product->get_tags( ', ', '<span class="tagged_as">' . _n( '<span class="product_meta_separator"> / </span><span class="product_meta_title">Tag:</span>', '<span class="product_meta_title">Tags:</span>', sizeof( get_the_terms( $post->ID, 'product_tag' ) ), 'mr_tailor' ) . ' ', '.</span>' ); ?>
