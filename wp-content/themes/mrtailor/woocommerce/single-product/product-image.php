...
<div class="images">
    ...
    <div class="product_images">
        ...
        <div id="product-images-carousel" class="owl-carousel">
            ...
            echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<div><a data-fresco-group="product-gallery" data-fresco-options="fit: \'width\'" class="'.$modal_class.'" href="' . $image_link . '">%s<span class="product_image_zoom_button show-for-medium-up"><i class="getbowtied-icon-plus"></i></span></a></div>', $image ), $post->ID );
